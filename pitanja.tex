...
\section{Sta je klasifikacija? Klasifikacioni model?}
tbd
\section{Kako se dele ulazni podaci klasifikacije?}
tbd
\section{Nabrojati tehnike klasifikacije.}
tbd
\section{Navesti primer primene modela drveta odlucivanja nad test podacima.}
tbd
...
tbd
\section{Opisati podelu zasnovanu na imenskim atributima.}
tbd
\section{Opisati podelu zasnovanu na rednim atributima.}
tbd
\section{Opisati podelu zasnovanu na neprekidnim atributima.}
tbd
\section{Kako odrediti najbolju podelu?}
tbd
...
tbd
\section{Kako se koristi GINI metoda pri podeli po binarnim atributima?}
tbd
\section{Kako se koristi GINI metoda pri podeli po kategorickim atributima?}
tbd
\section{Kako se koristi GINI metoda pri podeli po neprekidnim atributima?}
tbd
